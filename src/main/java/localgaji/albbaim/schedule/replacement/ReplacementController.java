...
public class ReplacementController {
    ...
    public ResponseEntity<Response<String>> postFixed(@AuthUser User user,
    ...
    public ResponseEntity<Response<String>> patchFixedSave(@AuthUser User user,
    ...
    public ResponseEntity<Response<GetReplacementList>> getReplacementList(@AuthUser User user,
                                                                           @PathVariable String startWeekDate,
                                                                           @RequestParam(defaultValue = "1") int page) {
        GetReplacementList replacementList = replacementService.getReplacementList(user, startWeekDate, page);
