...
ADD http://repo.maven.apache.org/maven2/com/navercorp/pinpoint/pinpoint-bootstrap/2.5.3/pinpoint-bootstrap-2.5.3.jar /pinpoint-agent-2.5.4/pinpoint-bootstrap-2.5.3.jar
